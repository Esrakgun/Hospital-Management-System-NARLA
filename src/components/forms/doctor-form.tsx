...
export const DoctorForm = () => {
  ...
  return (
    <Sheet >
      ...
      <SheetContent className="rounded-xl rounded-r-xl md:h-[90%] md:top-[5%] md:right-[1%] w-full overflow-y-scroll 2xl:p-3 p-5">
        <SheetHeader>
        ...
        <div>
          <Form {...form}>
            <form
              ...
              className="space-y-8 mt-5 2xl:mt-1"
            >
              <CustomInput
                type="radio"
                selectList={TYPES}
              ...
              <Button type="submit" disabled={isLoading} className="w-full 2xl:mb-5 mb-2">
                Submit
              </Button>
            </form>
          </Form>
