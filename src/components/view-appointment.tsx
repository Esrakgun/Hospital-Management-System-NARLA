...
import { AppointmentStatusIndicator } from "./appointment-status-ındicator";
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button
          variant="outline"
          className="flex items-center justify-center rounded-full bg-blue-500/10 hover:underline text-blue-600 px-3 py-1 text-xs md:text-sm">
          View
        </Button>
      </DialogTrigger>
