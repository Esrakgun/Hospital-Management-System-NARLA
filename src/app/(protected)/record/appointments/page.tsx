import { AppointmentStatusIndicator } from "@/components/appointment-status-ındicator";
    ...
    <div className="bg-white rounded-xl p-2 md:p-4 2xl:p-6">
      <div className="flex items-center justify-between">
        <div className="hidden lg:flex items-center gap-1">
          ...
          <p className="text-2xl font-semibold ml-1">{totalRecord ?? 0}</p>
          <span className="text-gray-600 text-sm xl:text-base ml-1">
            total appointments
          </span>
        </div>
